...
- (id)init
{
    ...
    [singleton setLeaderboardIdentifier:@"Woo_Woo_Leaderboard"];

    NSString *userLocale = [[NSLocale currentLocale] localeIdentifier];
    NSString *userLanguage = [userLocale substringToIndex:2];
    
    NSInteger punteggioRecord = [singleton get_punteggio];
    NSInteger numeroPartite = [singleton get_partita_giocata];
    NSInteger puntiTotali = [singleton get_punti_totali];
...
-(void)reportScore{
    ...
    score.value = [singleton get_punteggio];
