...
- (id)init
{
    ...
    punteggio = [singleton get_punteggio_temp];
    ...
    [singleton aggiungi_partita_giocata];
    [singleton aggiungi_punti_totali:punteggio];
    
    if([singleton get_punteggio] < punteggio) {
        //Nuovo record
        [singleton set_punteggio:punteggio];
